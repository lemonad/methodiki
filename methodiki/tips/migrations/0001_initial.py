...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tip'
        db.create_table('tips_tip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, blank=True, unique=True, populate_from=None, db_index=True)),
        ...
        db.send_create_signal('tips', ['Tip'])


    def backwards(self, orm):
        
        # Deleting model 'Tip'
        db.delete_table('tips_tip')
