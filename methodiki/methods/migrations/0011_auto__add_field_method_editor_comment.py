...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Method.editor_comment'
        db.add_column('methods_method', 'editor_comment', self.gf('django.db.models.fields.CharField')(default='-', max_length=80), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Method.editor_comment'
        db.delete_column('methods_method', 'editor_comment')
