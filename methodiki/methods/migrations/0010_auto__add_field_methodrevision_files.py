...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MethodRevision.files'
        db.add_column('methods_methodrevision', 'files', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MethodRevision.files'
        db.delete_column('methods_methodrevision', 'files')
