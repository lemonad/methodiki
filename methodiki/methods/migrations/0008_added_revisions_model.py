...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MethodRevision'
        db.create_table('methods_methodrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['methods.Method'])),
            ('revision', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True)),
            ('edited_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('editor_comment', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ...
            ('revision_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('methods', ['MethodRevision'])


    def backwards(self, orm):
        
        # Deleting model 'MethodRevision'
        db.delete_table('methods_methodrevision')
    ...
    models = {
        ...
        'comments.comment': {
            ...
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '100000'}),
        ...
        'customcomments.customcomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'CustomComment', '_ormbases': ['comments.Comment']},
            'comment_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['comments.Comment']", 'unique': 'True', 'primary_key': 'True'}),
            'lift_method': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'})
        },
        'methods.method': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edited_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"}),
        ...
        'methods.methodrevision': {
            'Meta': {'ordering': "['-revision']", 'object_name': 'MethodRevision'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'edited_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'editor_comment': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['methods.Method']"}),
            'revision': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}),
            'revision_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
