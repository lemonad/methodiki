...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'MethodRevision', fields ['title']
        db.delete_unique('methods_methodrevision', ['title'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'MethodRevision', fields ['title']
        db.create_unique('methods_methodrevision', ['title'])
